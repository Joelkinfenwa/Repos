...
// Smooth zoom into screenshots inside phone mockups
// Overlay text: "30+ biomarkers", "No GP referral", "Results in 48 hours"
// Parallax movement + 3D tilt on phone mockups
...
const PhoneScreen: React.FC<ScreenProps> = ({
  src,
  startFrame,
  endFrame,
  scrollStart = 0,
  ...
  // Zoom: start at 0.85 scale, zoom to 1.0
  const scale = interpolate(local, [0, dur], [0.85, 1.05], {
    extrapolateRight: 'clamp',
  });

  // Parallax scroll on screenshot
...
export const Scene4ShowSite: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <PhoneScreen src="homepage.png" startFrame={0} endFrame={80} scrollStart={0} scrollEnd={250} />

      {/* Screenshot 2: Landing page — frames 70-145 */}
      <PhoneScreen src="landing.png" startFrame={70} endFrame={145} scrollStart={0} scrollEnd={180} />

      {/* Screenshot 3: Product page — frames 135-200 */}
      <PhoneScreen src="product.png" startFrame={135} endFrame={200} scrollStart={0} scrollEnd={120} />
      ...
      {OVERLAYS.map((item, i) => {
        ...
        return (
          <div
            ...
            style={{
              position: 'absolute',
              bottom: 180 + i * 0, // stack at same position, they appear sequentially
              left: '50%',
